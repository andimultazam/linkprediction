...
def run_katz_algo(sc, masterTrainEdgeFile):
...
def validate_result(topKSuggestions):
...
if __name__ == '__main__':
    ...
    outFile = trainFolder+"/nodePair_katz.result"
    Utils.removeExistingDir(outFile)
    topKSuggestions = run_katz_algo(sc, masterTrainEdgeFile)
    validate_result(topKSuggestions)
